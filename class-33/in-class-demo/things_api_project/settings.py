...
SECRET_KEY = 'django-insecure-b!)zsb7yoy$%&kuxj^8bzg7o12dmr7p6y^(cp!0qej#*8hx1-8'
...
MIDDLEWARE = [
    ...
    # NEW!
    "whitenoise.middleware.WhiteNoiseMiddleware",  # location is important!
